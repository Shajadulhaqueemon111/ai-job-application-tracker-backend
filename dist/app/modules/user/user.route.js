...
route.get('/', (0, authValidation_1.default)(user_constant_1.USER_ROLE.admin), user_controller_1.userController.getAllUser);
route.get('/:id', (0, authValidation_1.default)(user_constant_1.USER_ROLE.admin), user_controller_1.userController.getSingleUser);
